    ...
    def substitution(self, substitutes):
        ...
        if len(substitutes[0]) == 0:
            ...
            answer = self.check_input(
                "\nSome substitutes are available. Do you want to visit "
                "them?\n\n1:no\n2:yes\n\nYour answer:",
                self.selection,
            )
            if answer == 2:
        ...
        while True:
            try:
                ...
                if val > 0 and val in select:
                    ...
                    num = input(
                        "Input must be one of the index displayed. Try again: "
                    )
                else:
                    num = input(
                ...
                try:
                    ...
                    num = input(
                        ...
                        "integer number. Please, try again: "
                    )
                except ValueError:
                    num = input(
                        "This is not a number. Please enter a valid "
                        "number. Try again: "
                    )
    ...
    def cli(self):
        ...
        while continu:
            ...
            choice_subs = self.control.check_input(
                "\nChoose the index of a product to substitute: ", records_prod,
            )
            selec = [(1, 1), (2, 2)]
            choice = self.control.check_input(
